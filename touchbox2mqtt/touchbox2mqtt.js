...
// yes, these are "temporarly" hardcoded here for my usecase
...
//I might create an include file for these constans.
...
//YMMV: use evtest(1) to find out the maximum values of ABS_MT_POSITION_X and ABS_MT_POSITION_Y
//for your touchscreens. I've got two different make touchscreens and these values differ.
const max_x = 16384;
const max_y = 9600;

//This is the Multiview layout for the BMD Atem Mini Pro switcher
...
const boxes = ATEMMiniProBoxes;

//let's proceed with per-box timeout objects for preparing for multitouch support
